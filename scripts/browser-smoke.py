...
with sync_playwright() as p:
    ...
    check('Monte Carlo worker completes',lambda:page.get_by_text('Monthly stress heatmap').wait_for())
    ...
    check('Mobile navigation',lambda:pg.get_by_text('Application sandbox').wait_for())
    ...
    check('Mobile Monte Carlo worker',lambda:pg.get_by_text('Monthly stress heatmap').wait_for())
