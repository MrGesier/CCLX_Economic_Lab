...
The Overview explains the architecture, limits and launch gates. Mock application provides fictitious wallet balances, synthetic CEX/DEX purchases and sales, CO2BIT conversion, project-specific collateral pools, restricted and ordinary deposits/withdrawals, time accrual, reward claims, milestone verification and a transaction ledger. No blockchain transaction is submitted.
